...
public class stordercard//used to format orderframe for store
{
    View card;
    String name;
    String place;
    ...
    stordercard(View card, String name, String place, String address, Drawable icon, Context context, int points)
    {
        this.card = card;
        this.name = name;
        this.place = place;
    ...
    {
        new stordercard(card, "McDonalds", "Pentagon", "idk", ContextCompat.getDrawable(context, R.drawable.mc_donald), context, points);
    }
    static void koi(View card, Context context, int points)//Koi widget
    {
        new stordercard(card, "Koi", "Changi City Point", "#B1-18", ContextCompat.getDrawable(context, R.drawable.jumbomilktea_removebg_preview), context, points);
    }
