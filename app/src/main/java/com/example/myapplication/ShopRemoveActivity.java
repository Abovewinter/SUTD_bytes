    ...
    private void insertorder(String store, int points)//Inserts order widgets into scrollview
    {
        ...
        switch(store)
        {
            case "mc"://strings are just for testing
                stordercard.mcd(ord, this, points);//static method of stordercard, formats orderframe into McDonald's widget(example)
                break;
            case "koi":
                stordercard.koi(ord, this, points);//static method of stordercard, formats orderframe into Koi widget
                break;
